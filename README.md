...
- **KI-Integration** — produktionsnahe LLM-Anbindung über einen beliebigen OpenAI-kompatiblen Endpunkt (Retry-Logik, versionierte Prompts, RAG), lokale Embeddings via sentence-transformers
